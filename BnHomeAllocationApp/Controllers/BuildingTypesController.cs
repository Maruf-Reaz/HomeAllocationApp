...
namespace BnHomeAllocationApp.Controllers
{
    public class BuildingTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] BuildingType buildingType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] BuildingType buildingType)
        {
